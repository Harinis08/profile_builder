...
<div class="header">
  <div class="header-right">
    <form method="POST" action="search.php" style="display: inline-block;">
      <input type="text" placeholder="Search by name" name="search" style="padding: 5px;margin-top:12px;">
      <button type="submit" style="padding: 10px 20px; background-color: #0066b2; color: white; border: none; border-radius: 4px; cursor: pointer;">Search</button>
    </form>

    <a href="dashboard_mentor.php">Dashboard</a>
    <a href="recommendations_mentor.php">Recommendations</a>
    <a href="track_skill_mentor.php">Track skills</a>
    <a href="track_progress_mentor.php">Track progress</a>
