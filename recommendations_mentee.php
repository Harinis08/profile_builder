...
<body>
    <?php
        ...
        $sql = "SELECT M.uname, R.status
                FROM Mentor M
                INNER JOIN Mentee E ON E.areas_of_interest = M.areas_of_interest
                LEFT JOIN requests R ON E.uname = R.mentee_uname AND M.uname = R.mentor_uname
                WHERE E.uname = '$uname'";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                if ($requestStatus == "accepted") {
                    echo "<button class='request-button following' disabled>Following</button>";
                } else {
